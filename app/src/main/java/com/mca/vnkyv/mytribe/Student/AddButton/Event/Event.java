...
public class Event {
    ...
    public Event(String title, String description, String imageUri, String uid, String creatorName, String course, String year, String creatorEmail, String commNote) {
        this.title = title;
